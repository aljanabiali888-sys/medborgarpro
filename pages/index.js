  ...
  return (
    <>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '20px' }}>
        ...
        {/* Free Test Button */}
       <div style={{ textAlign: 'center', marginBottom: '40px' }}><a href="#" onClick={() => window.location.href = '/free-test'}
 style={{ display: 'inline-block', padding: '15px 30px', background: '#fff', color: '#2563eb', border: '2px solid #2563eb', borderRadius: '50px', fontWeight: 'bold', fontSize: '1.1rem', textDecoration: 'none', boxShadow: '0 4px 6px rgba(37, 99, 235, 0.1)' }}>✓ {freeTest}</a></div>
